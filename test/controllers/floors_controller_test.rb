...
class FloorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create floor" do
    assert_difference('Floor.count') do
      post floors_url, params: { floor: { information: @floor.information, pos_x: @floor.pos_x, pos_y: @floor.pos_y, tags: @floor.tags } }
    end
  ...
  test "should update floor" do
    patch floor_url(@floor), params: { floor: { information: @floor.information, pos_x: @floor.pos_x, pos_y: @floor.pos_y, tags: @floor.tags } }
